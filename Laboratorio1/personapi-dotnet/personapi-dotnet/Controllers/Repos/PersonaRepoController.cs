...
{
    public class PersonaRepoController : Controller
    {
        private readonly persona_dbContext _context;

        public PersonaRepoController(persona_dbContext context)
        {
            _context = context;
        }
        ...
        // GET: PersonaRepo/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: PersonaRepo/Create
